angular.module('beAppli.directives', [])
...
.directive('searchInput', function($timeout, SearchService, $ionicLoading, locale){
	return {
		require: '^wpSearch',
			...
			element.on('keyup', function(event) {
				...
				timeout = $timeout(function(){
					...
					if(query.trim().length>0)
					{
						...
						$ionicLoading.show({
							template: locale.getString('app.search-in-progress')
						});
